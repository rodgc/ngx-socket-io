...
- `@angular/*` dependencies to v22.0.0.
- `ng-packagr` dependencies to v22.0.0.
- `typescript` dependencies to v6.0.0.

## [4.10.0] - 2025-12-23

### Bump

- `@angular/*` dependencies to v21.0.0.
- `typescript` dependencies to v5.8.0.
